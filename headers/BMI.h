...
BMI::BMI (double height, double weight) {
    if (height <= 0 || weight <= 0) {
        throw invalid_argument("Height or weight cannot be less than or equal to 0.");
    }
...
void BMI::setHeight (double height) {
    if (height <= 0) {
        throw invalid_argument("Height cannot be less than or equal to 0.");
    }
...
void BMI::setWeight (double weight) {
    if (weight <= 0) {
        throw invalid_argument("Weight cannot be less than or equal to 0.");
    }
